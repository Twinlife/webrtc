...
case ${TARGET} in
    ...
    android)
	$gn gen out-64/Release --args="target_os=\"android\" target_cpu=\"arm64\" ${ARGS} is_official_build=true libyuv_disable_jpeg=true rtc_build_tools=false use_errorprone_java_compiler=false is_debug=false"
	;;
