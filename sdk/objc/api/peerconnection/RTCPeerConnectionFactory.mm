...
#endif
  return [self initWithMediaAndDependencies:dependencies hostnames:nil];
}
...
- (instancetype)
  ...
  return [self initWithMediaAndDependencies:dependencies hostnames:hostnames];
#endif
}
...
- (instancetype)initWithMediaAndDependencies:
  ...
  return [self initWithNativeDependencies:dependencies hostnames:hostnames];
}
