...
echo    "     third_party"
cd $ROOT/base/third_party/dynamic_annotations
echo -n "      dynamic_annotations:                "
git rev-parse HEAD

cd $ROOT/base/third_party/libevent
echo -n "      libevent:                           "
git rev-parse HEAD

cd $ROOT/base/third_party/symbolize
echo -n "      symbolize:                          "
git rev-parse HEAD

cd $ROOT/base/third_party/xdg_mime
echo -n "      xdg_mime:                           "
git rev-parse HEAD

cd $ROOT/base/third_party/xdg_user_dirs
echo -n "      xdg_user_dirs:                      "
git rev-parse HEAD
...
cd $ROOT/build/linux/debian_sid_amd64-sysroot
echo -n "     linux/debian_sid_amd64-sysroot:      "
git rev-parse HEAD
...
cd $ROOT/third_party/googletest
echo -n "     googletest:                          "
git rev-parse HEAD

cd $ROOT/third_party/google_benchmark
echo -n "     google_benchmark:                    "
git rev-parse HEAD
