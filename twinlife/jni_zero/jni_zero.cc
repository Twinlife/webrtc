...
// --twinlife-- 2026-02-11: don't create the empty Map and List objects
...
#if 0 // --twinlife-- 2026-02-11: don't create the empty Map and List objects
#if defined(JNI_ZERO_MULTIPLEXING_ENABLED)
extern  Java_JniInit_crashIfMultiplexingMisaligned(env, kJniZeroHashWhole,
...
#endif // --twinlife-- 2026-02-11: don't create the empty Map and List objects
}
